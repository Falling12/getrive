...
const LOGS = [
  {
    id: "Built on itself",
    body: "Getrive finds its own first users the same way — by watching Reddit, Hacker News, IndieHackers, Stack Exchange, and Ask MetaFilter for founders describing exactly this problem, and drafting a genuine reply.",
