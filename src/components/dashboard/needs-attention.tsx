...
import { HourglassIcon, AlertTriangle, ArrowRight } from "lucide-react";
...
export function NeedsAttention({
  ...
  const isEmpty = agingSignals.length === 0 && failingSources.length === 0;

  return (
    <section data-tour="needs-attention" className="mt-16 flex w-full flex-col gap-6 md:mt-20">
